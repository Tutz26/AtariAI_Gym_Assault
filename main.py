...
# Parsers for arguments in python run:
...
# Image Preprocessing for atari games in Gym,
def prepro(I):
    """ prepro 210x160x3 uint8 frame into 6400 (80x80) 1D float vector """
    I = I[35:195]  # crop the image to remove unused area
...
# Initialize Environment with GYM using the pong game
...
while True:
    ...
    # Initialize variables for episode processing
    ...
    while not episode_done:
        # Render argument in while to look as animation.
        if args.render:
            env.render()


        # Analize observations to decide action based on probability
        ...
        # Reward action when observations is good based on policy network
        ...
        # Print rewards obtained or lost
    ...
    # exponentially smoothed version of reward to optimize ai processing
